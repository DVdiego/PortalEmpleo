...
public class UserWriter implements MessageBodyWriter<Users>{
    ...
    @Override
    public long getSize(Users t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
        return -1;
    }
